...
import com.formakers.fomes.appbee.adapter.holder.RegisteredInterviewItemViewHolder;
...
public class RegisteredInterviewListAdapterTest {
    ...
    public void setUp() throws Exception {
        ...
        Project.Interview interview1 = new Project.Interview(11L, null, "인터뷰소개", mockInterviewDate1, openDate, closeDate, "우면사업장", "C동 1층 107호 회의실", 0, null, "time15", "010-1234-5678", "오프라인", "스벅쿠폰 3만원");
        ...
        Project.Interview interview2 = new Project.Interview(22L, null, "인터뷰소개", mockInterviewDate2, createMockDate(2017, DECEMBER, 27), createMockDate(2017, DECEMBER, 28), "수원사업장", "5층 회의실", 5, null, "time8", "010-1111-2222", "온라인", "스벅쿠폰 3만원");
