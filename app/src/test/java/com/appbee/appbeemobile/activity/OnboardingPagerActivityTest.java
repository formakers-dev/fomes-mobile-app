...
public class OnboardingPagerActivityTest {

    private OnboardingPagerActivity subject;

    @Before
    public void setUp() throws Exception {
        subject = Robolectric.setupActivity(OnboardingPagerActivity.class);
    }
    ...
    public void OnboardingActivity가_onCreate시_구글ID로시작하기버튼이보인다() throws Exception {
        ...
        assertThat(subject.loginButton.getText()).isEqualTo("Google로 쉬운 시작");
    }
