...
public class InterviewDetailActivityTest extends ActivityTest {
    ...
    public void setUp() throws Exception {
        ...
        Interview interview = new Interview(1L, Collections.singletonList("네이버웹툰"), interviewDate, openDate, closeDate, "우면사업장", "오시는길입니다", 5, Arrays.asList("time8", "time9", "time10"), "", "", "오프라인 인터뷰");
